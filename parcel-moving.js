jQuery(document).ready(function ($) {
   ...
   const dateInput = $('.date-input');
       ...
       dateInput.attr('placeholder', 'Umzugsdatum');
   
       // Initialize jQuery UI Datepicker
       dateInput.datepicker({
           dateFormat: "dd/mm/yy", // Set your preferred date format
           showAnim: "slideDown",
           onClose: function() {
       ...
       // Remove placeholder on focus to avoid overlap
       ...
       dateInput.on('blur', function() {
           if (!$(this).val()) {
               $(this).attr('placeholder', 'Umzugsdatum');
           }
       });
